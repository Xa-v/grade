    ...
    <main>
      {loading ? (
        ...
        <thead>
          <tr>
            <th class="name" ></th>
            <th colSpan="12" className="text-center flex-fill">ATTENDANCE</th>
            <th></th>
          </tr>
          <tr>
            <td></td>
            <td class="inputgrade bg-success ">A1</td>
            <td class="inputgrade bg-success ">A2</td>
            <td class="inputgrade bg-success ">A3</td>
            <td class="inputgrade bg-success ">A4</td>
            <td class="inputgrade bg-success ">A5</td>
            <td class="inputgrade bg-success ">A6</td>
            <td class="inputgrade bg-success ">A7</td>
            <td class="inputgrade bg-success ">A8</td>
            <td class="inputgrade bg-success ">A9</td>
            <td class="inputgrade bg-success "> A10</td>
        ...
        <tbody>
          {grades.map((grade) => (
            <tr key={grade.gradeid}>
              <td>{grade.name}</td>
              {['a1', 'a2', 'a3', 'a4', 'a5', 'a6', 'a7', 'a8', 'a9', 'a10'].map((field) => (
                <td key={field}>
                  <input
                    type="number"
                    name={field}
